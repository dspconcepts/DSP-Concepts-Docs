...
This document is meant to be a "Quick-Start" on how to integrate AWE Core. Advanced concepts are left out. Before reading this document, please see the [Theory Of Operation](theory-of-operation.md).
